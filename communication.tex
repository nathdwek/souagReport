...
Le message envoyé au robot est codé sur 13 bits. Le premier et le dernier sont des \ilcode{0}et sont respectivement le start bit et le stop bit: il permette de détecter le début et la fin d'une trame. Le bit 11 est un bit de parité pour la détection d'erreur. Les \SI{10} bits restant contiennent l'information utile, les deux premiers donnent l'ordre suivant la convention suivante :
\begin{itemize}
...
\caption{Sortie de notre filtre (en bleu) pour une entrée de \SI{900}{\hertz} (en rouge)}
\label{fig:filtreAnalog900Hz}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width = 0.7\textwidth]{filtreAnalog1100Hz.pdf}
\caption{Sortie de notre filtre (en bleu) pour une entrée de \SI{1100}{\hertz} (en rouge)}
\label{fig:filtreAnalog1100Hz}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width = 0.7\textwidth]{filtreAnalog13kHz.pdf}
\caption{Sortie de notre filtre (en bleu) pour une entrée de \SI{13}{\kilo\hertz} (en rouge)}
\label{fig:filtreAnalog13kHz}
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width = 0.7\textwidth]{filtreAnalogFc.pdf}
\caption{Sortie de notre filtre (en bleu) pour une entrée à la fréquence de coupure (en rouge)}
