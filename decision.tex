...
L'ordre et le paramètres sont interprétés par la fonction \ilcode{interpretCommand(unsigned char order, unsigned char param)}. En fonction de la valeur de \ilcode{order},  
