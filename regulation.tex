...
\end{figure}
La fonction \ilcode{updateConsignes} génère les consignes. Il s'agit simplement d'une double intégration de l'accélération (angulaire) puis de la vitesse (angulaire), avec en plus une mise à zéro de l'accélération lorsque la vitesse dépasse la vitesse de croisière.
